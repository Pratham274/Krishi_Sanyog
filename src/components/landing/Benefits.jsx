      ...
      <div className="w-full max-w-[1700px] mx-auto px-6 sm:px-10 lg:px-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 space-y-6 text-left">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-teal-100 dark:bg-teal-950/60 text-teal-700 dark:text-teal-300 text-xs font-extrabold uppercase tracking-wider">
              Proven Impact & ROI
            </div>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-extrabold text-slate-900 dark:text-white text-base sm:text-lg">Up to 25% Reduction in Fertilizer Costs</h4>
              ...
              <div className="flex items-start gap-4">
                <div className="w-7 h-7 rounded-full bg-amber-100 dark:bg-amber-950 text-amber-600 dark:text-amber-400 flex items-center justify-center shrink-0 mt-0.5">
                  <Check className="w-4.5 h-4.5" />
                </div>
                <div>
                  <h4 className="font-extrabold text-slate-900 dark:text-white text-base sm:text-lg">35%+ Increase in Harvest Quality & Yield</h4>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-extrabold text-slate-900 dark:text-white text-base sm:text-lg">Direct Subsidies & Government Scheme Access</h4>
          ...
          <div className="lg:col-span-6 space-y-6">
            <div className="glass-card p-8 rounded-3xl border border-slate-200 dark:border-slate-800 space-y-4">
              <div className="flex justify-between items-center text-base font-bold">
                ...
                <span className="text-emerald-600 dark:text-emerald-400 font-extrabold">94% Optimal</span>
              </div>
            ...
            <div className="glass-card p-8 rounded-3xl border border-slate-200 dark:border-slate-800 space-y-4">
              <div className="flex justify-between items-center text-base font-bold">
                ...
                <span className="text-amber-500 font-extrabold">+₹42,500 / Hectare</span>
              </div>
              <div className="w-full h-3.5 rounded-full bg-slate-200 dark:bg-slate-800 overflow-hidden">
            ...
            <div className="glass-card p-8 rounded-3xl border border-slate-200 dark:border-slate-800 space-y-4">
              <div className="flex justify-between items-center text-base font-bold">
                ...
                <span className="text-blue-500 font-extrabold">30% Water Saved</span>
              </div>
              <div className="w-full h-3.5 rounded-full bg-slate-200 dark:bg-slate-800 overflow-hidden">
