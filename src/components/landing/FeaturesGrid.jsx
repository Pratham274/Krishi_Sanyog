        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10">
          {features.map((item) => {
            ...
            return (
              <div
                key={item.id}
                className={`p-8 sm:p-10 rounded-3xl bg-white dark:bg-slate-900 border ${item.borderColor} shadow-xl shadow-slate-200/40 dark:shadow-none hover:-translate-y-2 transition-all duration-300 flex flex-col justify-between group relative overflow-hidden`}
              >
                <div>
